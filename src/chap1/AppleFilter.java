...
public class AppleFilter {
    ...
    public static void main(String[] args) {
        List<Apple> list = Arrays.asList(
                new Apple("green", 23.4),
                new Apple("red", 80.3),
                new Apple("green", 90.2));
        ...
        List<Apple> list3 = filterByWeightAndLambda(list , (Apple apple) -> "green".equals(apple.getColor()));
        List<Apple> list4 = filterByWeightAndLambda(list , (Apple apple) -> apple.getWeight() > 30);
        List<Apple> list5 = filterByWeightAndLambda(list , (Apple apple) -> apple.getWeight() > 30 && "green"
